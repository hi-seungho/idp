    ...
    //var dep2 = 0;
        ...
        <div id="sub_container" class="clfl">
            ...
            <div class="subcontents_wrap">
                ...
                <img class="mb40" src="/front/image/community/review/img_top.jpg"/>
                ...
                <table cellpadding="0" cellspacing="0" class="tb_type9">
                    ...
                    <tbody>
                        <tr class="notice">
                            <td>공지</td>
                            <td><a href="news_view.php">제목이 들어갑니다.<img class="ml10 mr05" src="/front/image/common/board/ico_file.png"/><img src="/front/image/common/board/ico_link.png"/></a></td>
                            <td>홍길동</td>
                            <td>2016-12-12</td>
                            <td>9999</td>
                        </tr>
                        <tr class="notice">
                            <td>공지</td>
                            <td><a href="news_view.php">제목이 들어갑니다.</a></td>
                            <td>홍길동</td>
                            <td>2016-12-12</td>
                            <td>9999</td>
                        </tr>
                        <tr>
                            <td>8</td>
                            <td><a href="review_view.php">제목이 들어갑니다.<img class="ml05" src="/front/image/common/board/ico_new.png"/></a></td>
                            <td>홍길동</td>
                            <td>2016-12-12</td>
                            <td>9999</td>
                        </tr>
                ...
                <div class="ar mt20">
                    <a href="review_write.php"><img src="/front/image/common/board/btn_write.gif"/></a>
                </div>
