		...
		<div id="sub_container" class="clfl">
			...
			<div class="subcontents_wrap">
				...
				<ul class="ranktab clfl">
					<li><img src="/front/image/aus/ranking/btn1_on.gif" alt=""/></li>
					<li><a href="ranking_major.php"><img src="/front/image/aus/ranking/btn2_off.gif" alt=""/></a></li>
				</ul>
				<img class="mt40" src="/front/image/aus/ranking/cont1.jpg"/>
			</div>
		</div>
<?php
