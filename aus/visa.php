		...
		<div id="sub_container" class="clfl">
			...
			<div class="subcontents_wrap">
				<ul class="title_wrap clfl">
					<li class="title fl"><img src="/front/image/aus/visa/title.gif"/></li>
				...
				<img src="/front/image/aus/visa/cont1.jpg"/>
				<ul class="visa_btn clfl">
					<li><a href="/download/visa1.pdf"><img src="/front/image/aus/visa/btn1.gif"/></a></li>
					<li><a href="/download/visa2.pdf"><img src="/front/image/aus/visa/btn2.gif"/></a></li>
				</ul>
				<img src="/front/image/aus/visa/cont2.jpg"/>
			</div>
		</div>
<?php
