...
<style>
    ...
    <div class="quick_pop_wrap">
        <form name="fwrite" id="fwrite" action="<?php echo G5_BBS_URL; ?>/write_update.php" onsubmit="return fwrite_submit(this);" method="post" enctype="multipart/form-data" autocomplete="off" style="width:100%">
            ...
            <img class="mb30" src="/front/image/popup/estimate/top_img.gif"/>
            <table cellpadding="0" cellspacing="0" class="tb_type5">
                ...
                <!--<tr>
                    <td class="title">유학시점</td>
                    <td class="cont">
                        <input type="text" class="inp_text1" name="wr_3" value="" id="wr_3" size="10"><span class="sub_t ml10">년</span>
                        <ul class="radio_sel" style="margin-top: 10px;">
                            <li><input type="radio" name="wr_3" value="어학연수" class="input_chk"><label>어학연수</label></li>
                            <li><input type="radio" name="wr_3" value="전문대 과정" class="input_chk"><label>전문대 과정</label></li>
                            <li><input type="radio" name="wr_3" value="대학교 입학" class="input_chk"><label>대학교 입학</label></li>
                        </ul>
                    </td>
                </tr>-->
                <tr>
