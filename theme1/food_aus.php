    ...
    var dep2 = 0;
        ...
        <div id="sub_container" class="clfl">
            ...
            <div class="subcontents_wrap">
                ...
                <ul class="tab_3">
                    <li><a href="food_aus.php"><img src="/front/image/theme/food/tab1_on.gif" alt=""/></a></li>
                    <li><a href="food_ca.php"><img src="/front/image/theme/food/tab2.gif" alt=""/></a></li>
                    <li><a href="food_nz.php"><img src="/front/image/theme/food/tab3.gif" alt=""/></a></li>
                </ul>
                <img src="/front/image/theme/food/cont1.jpg"/>
            </div>
        </div>
<?php
