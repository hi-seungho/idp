        ...
        <div id="sub_container" class="clfl">
            ...
            <div class="subcontents_wrap">
                <ul class="title_wrap clfl">
                    <li class="title fl"><img src="/front/image/theme/aviation/title.gif"/></li>
                ...
                <ul class="tab_3">
                    <li><a href="aviation_aus.php"><img src="/front/image/theme/aviation/tab1.gif" alt=""/></a></li>
                    <li><a href="aviation_usa.php"><img src="/front/image/theme/aviation/tab2.gif" alt=""/></a></li>
                    <li><a href="aviation_nz.php"><img src="/front/image/theme/aviation/tab3_on.gif" alt=""/></a></li>
                </ul>
                <img src="/front/image/theme/aviation/cont3.jpg"/>
            </div>
        </div>
<?php
