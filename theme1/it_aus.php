        ...
        <div id="sub_container" class="clfl">
            ...
            <div class="subcontents_wrap">
                <ul class="title_wrap clfl">
                    <li class="title fl"><img src="/front/image/theme/it/title.gif"/></li>
                ...
                <ul class="tab_5">
                    <li><a href="it_aus.php"><img src="/front/image/theme/it/tab1_on.gif" alt=""/></a></li>
                    <li><a href="it_uk.php"><img src="/front/image/theme/it/tab2.gif" alt=""/></a></li>
                    <li><a href="it_usa.php"><img src="/front/image/theme/it/tab3.gif" alt=""/></a></li>
                    <li><a href="it_ca.php"><img src="/front/image/theme/it/tab4.gif" alt=""/></a></li>
                    <li><a href="it_nz.php"><img src="/front/image/theme/it/tab5.gif" alt=""/></a></li>
                </ul>
                <img src="/front/image/theme/it/cont1.jpg"/>
            </div>
        </div>
<?php
