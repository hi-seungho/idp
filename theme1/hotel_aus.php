    ...
    var dep2 = 0;
        ...
        <div id="sub_container" class="clfl">
            ...
            <div class="subcontents_wrap">
                ...
                <ul class="tab_5">
                    <li><a href="hotel_aus.php"><img src="/front/image/theme/hotel/tab1_on.gif" alt=""/></a></li>
                    <li><a href="hotel_uk.php"><img src="/front/image/theme/hotel/tab2.gif" alt=""/></a></li>
                    <li><a href="hotel_usa.php"><img src="/front/image/theme/hotel/tab3.gif" alt=""/></a></li>
                ...
                <img src="/front/image/theme/hotel/cont1.jpg"/>
            </div>
        </div>
<?php
