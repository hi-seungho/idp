        ...
        <div id="sub_container" class="clfl">
            ...
            <div class="subcontents_wrap">
                <ul class="title_wrap clfl">
                    <li class="title fl"><img src="/front/image/theme/food/title.gif"/></li>
                ...
                <ul class="tab_3">
                    <li><a href="food_aus.php"><img src="/front/image/theme/food/tab1.gif" alt=""/></a></li>
                    <li><a href="food_ca.php"><img src="/front/image/theme/food/tab2_on.gif" alt=""/></a></li>
                    <li><a href="food_nz.php"><img src="/front/image/theme/food/tab3.gif" alt=""/></a></li>
                </ul>
                <img src="/front/image/theme/food/cont2.jpg"/>
            </div>
        </div>
<?php
