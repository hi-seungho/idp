    ...
    var dep2 = 0;
        ...
        <div id="sub_container" class="clfl">
            ...
            <div class="subcontents_wrap">
                ...
                <ul class="tab_3">
                    <li><a href="health_aus.php"><img src="/front/image/theme/health/tab1_on.gif" alt=""/></a></li>
                    <li><a href="health_ca.php"><img src="/front/image/theme/health/tab2.gif" alt=""/></a></li>
                    <li><a href="health_nz.php"><img src="/front/image/theme/health/tab3.gif" alt=""/></a></li>
                </ul>
                <img src="/front/image/theme/health/cont1.jpg"/>
            </div>
        </div>
<?php
