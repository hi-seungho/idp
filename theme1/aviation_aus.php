    ...
    var dep2 = 0;
        ...
        <div id="sub_container" class="clfl">
            ...
            <div class="subcontents_wrap">
                ...
                <ul class="tab_3">
                    <li><a href="aviation_aus.php"><img src="/front/image/theme/aviation/tab1_on.gif" alt=""/></a></li>
                    <li><a href="aviation_usa.php"><img src="/front/image/theme/aviation/tab2.gif" alt=""/></a></li>
                    <li><a href="aviation_nz.php"><img src="/front/image/theme/aviation/tab3.gif" alt=""/></a></li>
                </ul>
                <img src="/front/image/theme/aviation/cont1.jpg"/>
            </div>
        </div>
<?php
