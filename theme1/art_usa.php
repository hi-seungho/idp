        ...
        <div id="sub_container" class="clfl">
            ...
            <div class="subcontents_wrap">
                <ul class="title_wrap clfl">
                    <li class="title fl"><img src="/front/image/theme/art/title.gif"/></li>
                ...
                <ul class="tab_5">
                    <li><a href="art_aus.php"><img src="/front/image/theme/art/tab1.gif" alt=""/></a></li>
                    <li><a href="art_uk.php"><img src="/front/image/theme/art/tab2.gif" alt=""/></a></li>
                    <li><a href="art_usa.php"><img src="/front/image/theme/art/tab3_on.gif" alt=""/></a></li>
                    <li><a href="art_ca.php"><img src="/front/image/theme/art/tab4.gif" alt=""/></a></li>
                    <li><a href="art_nz.php"><img src="/front/image/theme/art/tab5.gif" alt=""/></a></li>
                </ul>
                <img src="/front/image/theme/art/cont3.jpg"/>
            </div>
        </div>
<?php
