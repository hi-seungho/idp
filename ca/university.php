        ...
        <div id="sub_container" class="clfl">
            ...
            <div class="subcontents_wrap">
                <ul class="title_wrap clfl">
                    <li class="title fl"><img src="/front/image/ca/university/title.gif"/></li>
                ...
                <img src="/front/image/ca/university/cont1.jpg"/>
                <img style="margin-top: 70px;" src="/front/image/ca/university/cont2.jpg" usemap="#001"/>
                <!--<map name="001">
