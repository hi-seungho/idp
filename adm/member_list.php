...
<div class="tbl_head02 tbl_wrap">
    ...
    <tr class="<?php echo $bg; ?>">
        ...
        <td headers="mb_list_auth" class="td_mbstat">
            ...
            if ($member['mb_level'] == $row['mb_level']) {
                echo '<input type="hidden" name="mb_level['.$i.']" value="'.$member['mb_level'].'">';
            } else {
                echo get_member_level_select("mb_level[$i]", 2, 3, $row['mb_level'], array(2=>'일반회원', 3=>'컨설턴트'));
            }
            ?>
        </td>
