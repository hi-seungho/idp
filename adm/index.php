...
<section>
    ...
    <div class="tbl_head01 tbl_wrap">
        ...
        <tr>
            ...
            <td class="td_mbname"><?php echo get_text($row['mb_tel']); ?></td>
            <td class="td_mbname"><?php echo get_text($row['mb_hp']); ?></td>
            <td class="td_mbname"><?php echo get_text($row['mb_email']); ?></td>
        </tr>
        <?php
            }
        if ($i == 0)
