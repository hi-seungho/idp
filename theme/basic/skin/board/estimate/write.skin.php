        ...
        <form name="fwrite" id="fwrite" action="<?php echo $action_url ?>" onsubmit="return fwrite_submit(this);" method="post" enctype="multipart/form-data" autocomplete="off" style="width:<?php echo $width; ?>">
            ...
            <div class="tbl_frm01 tbl_wrap">
                <table>
                    ...
                    <tr>
                        <th scope="row"><label for="wr_3">유학시점</label></th>
                        <td>
                            ...
                            <ul class="radio_sel" style="margin-top: 10px;">
                                <li><input type="radio" name="wr_4" <?php echo get_checked('어학연수', $write['wr_4']); ?> value="어학연수" class="input_chk"><label>어학연수</label></li>
                                <li><input type="radio" name="wr_4" <?php echo get_checked('전문대 과정', $write['wr_4']); ?> value="전문대 과정" class="input_chk"><label>전문대 과정</label></li>
                                <li><input type="radio" name="wr_4" <?php echo get_checked('대학교 입학', $write['wr_4']); ?> value="대학교 입학" class="input_chk"><label>대학교 입학</label></li>
                            </ul>
                        </td>
                    </tr>
