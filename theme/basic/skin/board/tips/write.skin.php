...
<div id="sub_container" class="clfl">
    ...
    <div class="subcontents_wrap">
        <ul class="title_wrap clfl">
            <li class="title fl"><img src="/front/image/community/tips/title.gif"/></li>
        ...
        <img class="mb40" src="/front/image/community/tips/img_top.jpg"/>
        ...
        <form name="fwrite" id="fwrite" action="<?php echo $action_url ?>" onsubmit="return fwrite_submit(this);" method="post" enctype="multipart/form-data" autocomplete="off" style="width:<?php echo $width; ?>">
            ...
            <div class="tbl_frm01 tbl_wrap">
                <table>
                    ...
                    <tr>
                        <th scope="row"><label for="wr_1">요약문구</label></th>
                        <td>
                            <textarea name="wr_1" id="wr_1" cols="30" rows="10" class="frm_input" maxlength="255"><?php echo $write['wr_1'] ?></textarea>
                        </td>
                    </tr>
