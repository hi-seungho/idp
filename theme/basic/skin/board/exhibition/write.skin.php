        ...
        <form name="fwrite" id="fwrite" action="<?php echo $action_url ?>" onsubmit="return fwrite_submit(this);" method="post" enctype="multipart/form-data" autocomplete="off" style="width:<?php echo $width; ?>">
            ...
            <div class="tbl_frm01 tbl_wrap">
                <table>
                    ...
                    <tr>
                        <th scope="row"><label for="wr_1">기간</label></th>
                        <td><input type="text" name="wr_1" value="<?php echo $write['wr_1'] ?>" id="wr_1" class="frm_input" size="50"></td>
                    </tr>

                    <tr>
                        <th scope="row"><label for="wr_2">요약문구</label></th>
                        <td>
                            <textarea name="wr_2" id="wr_2" cols="30" rows="10" class="frm_input" maxlength="255"><?php echo $write['wr_2'] ?></textarea>
                        </td>
                    </tr>

                    <tr>
                        <th scope="row"><label for="wr_3">기간</label></th>
                        <td>
                            <select name="wr_3" id="wr_3">
                                <option value="진행중" <?php echo get_selected('진행중', $write['wr_3']); ?>>진행중</option>
                                <option value="마감" <?php echo get_selected('마감', $write['wr_3']); ?>>마감</option>
                            </select>
                        </td>
                    </tr>
            ...
            <div class="btn_confirm">
                ...
                <a href="./board.php?bo_table=<?php echo $bo_table.$qstr ?>"><img src="/front/image/common/board/btn_cancel.gif" title=""></a>
            </div>
        </form>
